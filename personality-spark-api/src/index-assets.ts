...
app.get('/debug', (c) => {
  return new Response('OK - Assets Worker', {
    headers: {
...
// With Wrangler 4.x and [assets] configuration, static files are served automatically
// No need for manual asset handling
// The ASSETS binding is automatically injected
